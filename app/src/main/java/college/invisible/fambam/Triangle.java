package college.invisible.fambam;
...
public class Triangle {
    ...
    // Set color with red, green, blue and alpha (opacity)
    float color[] = { 0.63671875f, 0.7695312f, 0.22265625f, 1.0f };
    ...
    public void draw(float[] mvpMatrix) {
        ...
        // Enable a handle to the triangle vertex
        ...
        // Pass the project and view transformation to the shader
